<%@ Page Language="C#" AutoEventWireup="true" CodeFile="financeRequestLog.aspx.cs" Inherits="DesignLayer_Finance_financeRequestLog" %>
...
<body>
    <div class="left">
        <div class="navbar">
            <img src="../../logo.png">
            <a style="color: black;" href="/DesignLayer/Finance/financeHome.aspx">Home</a>
                    ...
                    <form runat="server">
                        ...
                        <asp:Table ID="dataTable" runat="server">
                            <asp:TableHeaderRow>
                                ...
                                <asp:TableHeaderCell>Degree Fee Paid</asp:TableHeaderCell>
