<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminUpdateStudentData.aspx.cs" Inherits="DesignLayer_Admin_adminUpdateStudentData" %>
...
<body>
    <div class="left">
        <div class="navbar">
            ...
            <a style="color: skyblue;" href="/DesignLayer/Admin/adminUpdateStudentData.aspx">Update Student Data</a>
                    ...
                    <form runat="server">
                        <asp:Table ID="dataTable" runat="server">
                            <asp:TableHeaderRow>
                                ...
                                <asp:TableHeaderCell>Required updation</asp:TableHeaderCell>
                                <asp:TableHeaderCell>Updated value</asp:TableHeaderCell>
                                <asp:TableHeaderCell>Option</asp:TableHeaderCell>
